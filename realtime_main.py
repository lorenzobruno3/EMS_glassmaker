...
## EMS DEFINITION PLOT
# ==================================================================================================================================================
P_ely_in_EMS_plot = np.zeros((time_end-planning_horizon,24))
P_ely_out_EMS_plot = np.zeros((time_end-planning_horizon,24))
DeltaON_EMS_PLOT = np.zeros((time_end-planning_horizon,24))
DeltaOFF_EMS_PLOT = np.zeros((time_end-planning_horizon,24))
DeltaSTB_EMS_PLOT = np.zeros((time_end-planning_horizon,24))
SigmaONOFF_EMS_PLOT = np.zeros((time_end-planning_horizon,24))
SigmaOFFON_EMS_PLOT = np.zeros((time_end-planning_horizon,24))
SigmaONSTB_EMS_PLOT = np.zeros((time_end-planning_horizon,24))
SigmaSTBON_EMS_PLOT = np.zeros((time_end-planning_horizon,24))
SigmaSTBOFF_EMS_PLOT = np.zeros((time_end-planning_horizon,24))
SigmaOFFSTB_EMS_PLOT = np.zeros((time_end-planning_horizon,24))
state_costs_EMS_plot = np.zeros((time_end-planning_horizon,24)) 
state_costs_EMS_STB_plot = np.zeros((time_end-planning_horizon,24))
state_costs_EMS_ON_plot = np.zeros((time_end-planning_horizon,24)) 
transition_costs_EMS_plot = np.zeros((time_end-planning_horizon,24))
# ==================================================================================================================================================
## EMS DEFINITION
# ==================================================================================================================================================
...
for index_cont in tqdm(range(time_end-planning_horizon)):
    ...
    CO2_NG = P_NG/LHV_NG*density_NG*CO2_prod_rate #[kW]*[kg/Nm3]*[kg/nM3]

    C_pv_cost = cp.multiply(P_pv_var,PV_cost[index_cont:index_cont + planning_horizon])
    ...
    C_tank_cost = P_tank_in*tank.OPEX ##########AAAAAA##########
    ...
    cost_emission_NG = cp.multiply(CO2_NG, environmental.carbon_cost)
    ...
    cost_total_opt = C_grid_cost + C_pv_cost + C_NG_cost + cost_emission_grid + cost_emission_NG + state_costs + transition_costs + C_comp_cost + C_tank_cost   ##########AAAAAA##########     ####################           + P_hydro_cost + C_ely_cost 
    objective = cp.sum(cost_total_opt)     #  
    # =========================================================================
    ## CONSTRAINTS
    # =========================================================================
    tank_constraints = tank.get_constraints()  ##########AAAAAA##########
    electro1_constraints_MOMO = electro1.get_constraints_MOMO(P_0, P_STB, P_ON, P_max, M, d_0_OFFely, d_0_STBely, d_0_ONely)  ##########AAAAAA##########
    other_constraints = [P_pv_var <= P_pv[index_cont:index_cont + planning_horizon],
                         ...
                         P_ely_out[0]-P_ely_inicial<= electro1.RAMP,  ##########AAAAAA##########
                         -P_ely_out[0]+P_ely_inicial<= electro1.RAMP,  ##########AAAAAA##########
    ...
    P_ely_inicial = P_ely_out[0].value  ##########AAAAAA##########
    d_0_OFFely = electro1.DeltaOFF[0].value  ##########AAAAAA##########
    d_0_STBely = electro1.DeltaSTB[0].value  ##########AAAAAA##########
    d_0_ONely = electro1.DeltaON[0].value  ##########AAAAAA##########
    #print(d_0_OFFely.value)
    #print(d_0_STBely.value)
    #print(d_0_ONely.value)
    # credo che l'ottimizzatore ottimizzi e non consideri i numeri iniziali delle variabili
...
# ==========================================================================
water_h2 = [mass_h2[ii]*(18/2) for ii in range(time_end-planning_horizon)]                            # [kg_h20]##########AAAAAA##########
water_h2_tot = sum(water_h2)                                                                        # [kg_h20]  ##########AAAAAA##########
# =========================================================================
...
#plt.show()
# =========================================================================
## plot: PV OVERALL COST
# ==========================================================================
#plt.plot(P_pv_var_plot, label="P_pv in the node")
#plt.plot(P_pv, label="P_pv")
#plt.legend()
#plt.xlabel('hours [h]')         #
#plt.ylabel('power [kW]')
#plt.title('PV SUPPLY and CURTAILMENT')
#plt.grid()
#plt.show()
# =========================================================================
## plot: OVERALL COST
# ==========================================================================
#plt.plot(cost_total_opt_plot, label="cost_total_opt")
#plt.legend()
#plt.xlabel('hours [h]')         #
#plt.ylabel('costs [€]')
#plt.title('TOTAL OVERALL COST of the system')
#plt.grid()
#plt.show()
# =========================================================================
...
# ==========================================================================
plt.plot(cost_emission_NG_plot, label="emissions NG")
plt.plot(cost_emission_grid_plot, label="emissions GRID")
plt.xlabel('hour [h]')         #
...
##########AAAAAA##########ax2 = ax.twinx()
##########AAAAAA##########ax2.plot(grid_price_purchase, label="grid price purchase", color="red")
##########AAAAAA##########ax2.plot(NG_price, label="NG price", color="black")
##########AAAAAA##########plt.ylabel('price [euro/kWh]')
##########AAAAAA##########plt.xlabel('hour [h]')         
##########AAAAAA##########plt.title('COMPARISON ELY OPERATION WITH GRID AND NG PRICES')
##########AAAAAA##########plt.legend()
##########AAAAAA##########plt.legend(loc=5)
##########AAAAAA##########plt.show()
# =========================================================================
...
# ==========================================================================
plt.plot(P_load_th_l, label="load THERMAL")
plt.plot(P_load_ele_l, label="load electric PLANT")
plt.plot(P_load_ele_FUR_l, label="load electric FURNACE")
plt.plot(P_load_th_TOT_plot, label="power TOTAL FURNACE")
#plt.plot(P_ely_out_plot, label="power OUT ely")
plt.xlabel('hour [h]')         #
plt.ylabel('power [kW]')
...
# Creazione DataFrame
df1 = pa.DataFrame({
    "DeltaON_PLOT": DeltaON_PLOT,
    "DeltaOFF_PLOT": DeltaOFF_PLOT,
    ...
    "SigmaONOFF_PLOT": SigmaONOFF_PLOT, 
    "SigmaOFFON_PLOT": SigmaOFFON_PLOT,
    "SigmaONSTB_PLOT": SigmaONSTB_PLOT,
    "SigmaSTBON_PLOT": SigmaSTBON_PLOT,
    "SigmaSTBOFF_PLOT": SigmaSTBOFF_PLOT,
    "SigmaOFFSTB_PLOT": SigmaOFFSTB_PLOT,
...
with pa.ExcelWriter('output_STEKLARNA_TOT_FINAL_SCE2_05_testingputput.xlsx') as writer:
    ...
    df4.to_excel(writer, sheet_name='emissions')
